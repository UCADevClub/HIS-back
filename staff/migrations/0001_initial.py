...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PatientManager',
            fields=[
                ('standarduser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='user_authentication.standarduser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speciality', models.ManyToManyField(related_name='doctors', to='staff.speciality')),
            ],
            options={
                'abstract': False,
            },
